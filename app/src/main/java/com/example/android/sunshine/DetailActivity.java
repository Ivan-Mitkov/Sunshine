...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mHighTemperatureView = (TextView) findViewById(R.id.high_temperature_tv);
        mLowTemperatureView = (TextView) findViewById(R.id.low_temperature_tv);
        mHumidityView = (TextView) findViewById(R.id.humidity_tv);
        mWindView = (TextView) findViewById(R.id.wind_tv);
        mPressureView = (TextView) findViewById(R.id.pressure_tv);

...
//   (1) Create a constant int value to identify the notification
    private static final int SUNSHINE_NOTIFICATION_ID = 1234;
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            int smallArtResources = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
            ...
            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                    .setSmallIcon(smallArtResources)
...
//           (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            nm.notify(SUNSHINE_NOTIFICATION_ID,notificationBuilder.build());
